 ...
 *
 */
public class MybatisControllerPluginZjy extends PluginAdapter{
...
//	private FullyQualifiedJavaType ApiOperation;
	...
	public MybatisControllerPluginZjy() {
		super();
...
//			RequestParam = new FullyQualifiedJavaType("org.springframework.web.bind.annotation.RequestParam");
			GetMapping = new FullyQualifiedJavaType("org.springframework.web.bind.annotation.*");
...
//		addLogger(topLevelClass);
	...
	protected void addController(TopLevelClass topLevelClass,IntrospectedTable introspectedTable, String tableName, List<GeneratedJavaFile> files) {
		...
		String path = toLowerCase(pojoType.getShortName().substring(0, pojoType.getShortName().length()));
...
//		}
	...
	protected Method getOtherSaveboolean(String methodName, IntrospectedTable introspectedTable, String tableName) {
		...
		method.addParameter(new Parameter(new FullyQualifiedJavaType(pojoType+"SaveParam"),"param","@RequestBody"));
...
//		method.addAnnotation("@ApiOperation(\""+info+"\")");
        method.addAnnotation("@ValidRestAuth");
        method.addAnnotation("@ValidRestParam");
	...
	protected Method getOtherDeleteboolean(String methodName, IntrospectedTable introspectedTable, String tableName) {
		...
		method.setName(methodName);
		method.setReturnType(new FullyQualifiedJavaType("RestResult<Integer>"));
		method.addParameter(new Parameter(new FullyQualifiedJavaType(pojoType+"DeleteParam"), "param","@RequestBody"));
		method.setVisibility(JavaVisibility.PUBLIC);
		method.addAnnotation("@PostMapping(\"/"+methodName+"\")");
...
//		method.addAnnotation("@ApiOperation(\""+info+"\")");
	...
	protected Method getOtherUpdateboolean(String methodName, IntrospectedTable introspectedTable, String tableName) {
		...
		method.setName(methodName);
		method.setReturnType(new FullyQualifiedJavaType("RestResult<Integer>"));
		method.addParameter(new Parameter(new FullyQualifiedJavaType(pojoType+"UpdateParam"), "param","@RequestBody"));
		method.setVisibility(JavaVisibility.PUBLIC);
		method.addAnnotation("@PostMapping(\"/"+methodName+"\")");
...
//		method.addAnnotation("@ApiOperation(\""+info+"\")");/
	...
	protected Method getOtherGetboolean(String methodName, IntrospectedTable introspectedTable, String tableName) {
		Method method = new Method();
		method.setName(methodName);
		method.setReturnType(new FullyQualifiedJavaType("RestResult<"+pojoType.getShortName()+">"));
		method.addParameter(new Parameter(new FullyQualifiedJavaType(pojoType+"GetParam"), "param","@RequestBody"));
		method.setVisibility(JavaVisibility.PUBLIC);
		method.addAnnotation("@PostMapping(\"/"+methodName+"\")");
        method.addAnnotation("@ValidRestAuth");
        method.addAnnotation("@ValidRestParam");
...
//		Method method = new Method();
//		method.setName(methodName);
//		method.setReturnType(RestResult);
//		method.addParameter(new Parameter(pojoType, toLowerCase(pojoType.getShortName()),"@RequestBody"));
//		method.setVisibility(JavaVisibility.PUBLIC);
//		method.addAnnotation("@PostMapping(\"/"+methodName+"\")");
...
//	}
	...
	protected Method getOtherPageboolean(String methodName, IntrospectedTable introspectedTable, String tableName) {
		...
		method.addParameter(new Parameter(new FullyQualifiedJavaType(pojoType+"PageParam"), "param","@RequestBody"));
		method.setVisibility(JavaVisibility.PUBLIC);
		method.addAnnotation("@PostMapping(\"/"+methodName+"\")");
        method.addAnnotation("@ValidRestAuth");
        method.addAnnotation("@ValidRestParam");
...
//		sb.append("\r\n\t\t");
		...
		sb.append("return ");
		sb.append(toLowerCase(interfaceType.getShortName())+".");
		sb.append("get"+pojoType.getShortName().substring(0, pojoType.getShortName().length())+"Page");
		sb.append("("+"param");
		sb.append(");");
		method.addBodyLine(sb.toString());
		addMethodComment(method,info);
