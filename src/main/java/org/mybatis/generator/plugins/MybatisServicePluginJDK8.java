 ...
 */
public class MybatisServicePluginJDK8 extends PluginAdapter{
...
//	private FullyQualifiedJavaType slf4jLoggerFactory;
	...
	private FullyQualifiedJavaType LocalDateTime;
	...
	public MybatisServicePluginJDK8() {
...
//		slf4jLoggerFactory = new FullyQualifiedJavaType("org.slf4j.LoggerFactory");
		...
		LocalDateTime = new FullyQualifiedJavaType("java.time.LocalDateTime");
	...
	protected Method getOtherInsertboolean(String methodName, IntrospectedTable introspectedTable, String tableName, boolean enableAnnotation) {
		...
		for (IntrospectedColumn introspectedColumn : introspectedTable
			...
			if("gmt_update".equals(introspectedColumn.getActualColumnName())){
				...
				sb.append(".setGmtUpdate(LocalDateTime.now());");
				sb.append("\r\n\t\t");
			}
			if("gmt_create".equals(introspectedColumn.getActualColumnName())){
				sb.append(toLowerCase(pojoType.getShortName()));
				sb.append(".setGmtCreate(LocalDateTime.now());");
				sb.append("\r\n\t\t");
			}
		}
...
//		topLevelClass.addImportedType(slf4jLoggerFactory);
		...
		topLevelClass.addImportedType(LocalDateTime);
